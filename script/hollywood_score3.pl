...
my @mmtables = &makemmscores;
my @wmmtables = &makewmmscores;

print sprintf("%.2f\t", &log2(&scoreconsensus($seq)*&maxentscore(&getrest($seq),\@metables)));
print sprintf("%.2f\t", &log2(&scoreconsensus($seq)*&maxentscore(&getrest($seq),\@mmtables)));
print sprintf("%.2f\n", &log2(&scoreconsensus($seq)*&maxentscore(&getrest($seq),\@wmmtables)));
